  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeries.php"><li style="color: white; font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Inventories</li></a>
       <a href="addnew.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Add New Item</li></a>
      </ul><
    </div>
  </div>
