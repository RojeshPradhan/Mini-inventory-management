...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div style="background: #1A2226;font-size: 20px;padding: 16px;color: #79978F">MAIN NAVIGATION</div>
  <div>
    <div style="background:#1E282C;color: white;padding: 16px 18px;border-left: 3px solid #3C8DBC;"><span><i class="fa fa-dashboard fa-fw"></i> Dashboard</span></div>
    <div class="item">
      <ul class="nostyle zero">
        <a href="index.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Home</li></a>
        <a href="inventeries.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Inventories</li></a>
       <a href="addnew.php"><li style="color: white; font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Add New Item</li></a>
      </ul><
    </div>
  </div>
  ...
  <div class="item">
      <ul class="nostyle zero">
        <a href="sitesetting.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Site Setting</li></a>
        <a href="profile.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Profile Setting</li></a>
        <a href="accountSetting.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Account Setting</li></a>
        <a href="logout.php"><li style="font-size: 14px;padding: 9px; padding-left:20px"><i class="fa fa-circle-o fa-fw"></i> Sign Out</li></a>
      </ul><
    </div>
</div>
<div class="marginLeft" >
  <div style="color:white;background:#3C8DBC; padding:5px;" >
...
if ($con->query("insert into inventeries (catId,supplier,name,price,quantity,description) values ('$_POST[catId]','$_POST[supplier]','$_POST[name]','$_POST[price]','$_POST[quantity]','$_POST[discription]')"))  {
...
if (isset($_POST['updateItem'])) {
  $itemID=$_GET['item'];
if ($con->query("Update inventeries set supplier='$_POST[supplier]',name='$_POST[name]',price='$_POST[price]',quantity='$_POST[quantity]' where id=$itemID")) {
